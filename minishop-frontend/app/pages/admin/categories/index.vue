...
const totalPages = computed(() =>
  Math.max(1, Math.ceil(categories.value.length / pageSize)),
);
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-6 py-10 md:py-14">
        ...
        >
          <div
            ...
            @click="openCategoryProducts(category.id)"
            @keydown.enter="openCategoryProducts(category.id)"
          >
...
.category-card:hover .category-heading h3 {
  color: #f3d27a;
}
